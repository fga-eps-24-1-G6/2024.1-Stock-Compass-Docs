# Planejamento e Execução do Escopo
...
| AÇÕES     | Descrever conceitos de mercado | Eu, como usuário, desejo acessar descrições de conceitos do mercado financeiro para melhorar meu entendimento de ações.                               |
